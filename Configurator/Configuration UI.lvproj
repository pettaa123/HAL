...
<Project Type="Project" LVVersion="24008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Providers" Type="Folder">
			<Item Name="Database Provider.lvlib" Type="Library" URL="../CFG Provider/Database/Database Provider/Database Provider.lvlib"/>
			<Item Name="File Provider.lvlib" Type="Library" URL="../CFG Provider/Configuration Files Provider/File Provider/File Provider.lvlib"/>
		</Item>
		<Item Name="Clear Button.ctl" Type="VI" URL="../CFG Provider/Configuration Files Provider/File Provider/Clear Button.ctl"/>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="AI Current DAQmx Cont CFG.lvclass" Type="LVClass" URL="../../HAL/Devices/DAQmx/AI/AI Current DAQmx Cont CFG/AI Current DAQmx Cont CFG.lvclass"/>
			<Item Name="AI Voltage DAQmx Cont CFG.lvclass" Type="LVClass" URL="../../HAL/Devices/DAQmx/AI/AI Voltage DAQmx Cont CFG/AI Voltage DAQmx Cont CFG.lvclass"/>
			<Item Name="AO DAQmx DC CFG.lvclass" Type="LVClass" URL="../../HAL/Devices/DAQmx/AO/AO DAQmx DC CFG/AO DAQmx DC CFG.lvclass"/>
			<Item Name="Attribute Selector.ctl" Type="VI" URL="../../HAL/Devices/HSU MCU V2 CFG/HSU MCU V2 CFG/Attribute Selector.ctl"/>
			<Item Name="BufferLastReadsDBL.lvclass" Type="LVClass" URL="../../HAL/Devices/Buffers/BufferLastReadingsDBL/BufferLastReadsDBL.lvclass"/>
			<Item Name="BufferWrites1SamDBL.lvclass" Type="LVClass" URL="../../HAL/Devices/Buffers/BufferWrites1SamDBL/BufferWrites1SamDBL.lvclass"/>
			<Item Name="CO DAQmx PWM CFG.lvclass" Type="LVClass" URL="../../HAL/Devices/DAQmx/DIO/CO DAQmx PWM CFG/CO DAQmx PWM CFG.lvclass"/>
			<Item Name="COM Port Selector.vi" Type="VI" URL="../../HAL/Helper/COM Port Selector.vi"/>
			<Item Name="DAQmx Base CFG.lvclass" Type="LVClass" URL="../../HAL/Devices/DAQmx/DAQmx Base CFG/DAQmx Base CFG.lvclass"/>
			<Item Name="DAQmx BufferLastReadsDBL.lvclass" Type="LVClass" URL="../../HAL/Devices/DAQmx/DAQmx BufferLastReadsDBL/DAQmx BufferLastReadsDBL.lvclass"/>
			<Item Name="DAQmx Simulated CFGs.lvlib" Type="Library" URL="../../HAL/Devices/DAQmx/DAQmx Simulated CFGs.lvlib"/>
			<Item Name="Data Logger Actor.lvlib" Type="Library" URL="../../MAL/Data Logger Actor/Data Logger Actor/Data Logger Actor.lvlib"/>
			<Item Name="DO DAQmx Fixed Freq PWM CFG.lvclass" Type="LVClass" URL="../../HAL/Devices/DAQmx/DIO/DO DAQmx Fixed Freq PWM CFG/DO DAQmx Fixed Freq PWM CFG.lvclass"/>
			<Item Name="Generate JSON Schema VCluster.vi" Type="VI" URL="../../HAL/Helper/Generate JSON Schema VCluster.vi"/>
			<Item Name="Generate PWM.vi" Type="VI" URL="../../HAL/Devices/DAQmx/DIO/DO DAQmx Fixed Freq PWM CFG/Generate PWM.vi"/>
			<Item Name="HAL.lvlib" Type="Library" URL="../../HAL/HAL.lvlib"/>
			<Item Name="HSU MCU V2 CFG.lvclass" Type="LVClass" URL="../../HAL/Devices/HSU MCU V2 CFG/HSU MCU V2 CFG/HSU MCU V2 CFG.lvclass"/>
			<Item Name="ICAN.lvclass" Type="LVClass" URL="../../HAL/Protocols/ICAN/ICAN.lvclass"/>
			<Item Name="IData Logger Actor.lvlib" Type="Library" URL="../../MAL/Data Logger Actor/Data Logger Actor/IData Logger Actor/IData Logger Actor.lvlib"/>
			...
			<Item Name="ITask Actor.lvlib" Type="Library" URL="../../MAL/Task/ITask Actor/ITask Actor.lvlib"/>
			<Item Name="Look in Map.vi" Type="VI" URL="../../HAL/Helper/Look in Map.vi"/>
			...
			<Item Name="MCU Selector.ctl" Type="VI" URL="../../HAL/Devices/HSU MCU V2 CFG/HSU MCU V2 CFG/MCU Selector.ctl"/>
			...
			<Item Name="Panel Actor.lvlib" Type="Library" URL="../../../../gitlab/mgi-panel-manager-unmonitored/Source/Panel Manager/Panel Actor/Panel Actor.lvlib"/>
			<Item Name="Panel.lvlib" Type="Library" URL="../../../../gitlab/mgi-panel-manager-unmonitored/Source/Panel Manager/Panel/Panel.lvlib"/>
			<Item Name="PCAN.lvclass" Type="LVClass" URL="../../HAL/Devices/CAN Interfaces/PCAN/PCAN.lvclass"/>
			<Item Name="PCANBasic.dll" Type="Document" URL="PCANBasic.dll">
				<Property Name="NI.PreserveRelativePath" Type="Bool">true</Property>
			</Item>
			<Item Name="Point Selector.ctl" Type="VI" URL="../../../../gitlab/imponator-series-actor/Imponator Series Actor/Imponator Series UI Actor/Point Selector.ctl"/>
			<Item Name="Read Write PE Input.ctl" Type="VI" URL="../../HAL/Devices/Red-y/Configurations/Pressure Control CFG/Read Write PE Input.ctl"/>
			<Item Name="Red-y Pressure Control CFG Simulated.lvclass" Type="LVClass" URL="../../HAL/Devices/Red-y/Configurations/Pressure Control CFG Simulated/Red-y Pressure Control CFG Simulated.lvclass"/>
			<Item Name="Red-y Pressure Control CFG.lvclass" Type="LVClass" URL="../../HAL/Devices/Red-y/Configurations/Pressure Control CFG/Red-y Pressure Control CFG.lvclass"/>
			...
			<Item Name="Strict Find Items as LV Type.vim" Type="VI" URL="../../HAL/Helper/Strict Find Items as LV Type.vim"/>
			<Item Name="systemLogging.dll" Type="Document" URL="systemLogging.dll">
				<Property Name="NI.PreserveRelativePath" Type="Bool">true</Property>
			</Item>
			<Item Name="Task Actor.lvlib" Type="Library" URL="../../MAL/Task/Task Actor/Task Actor.lvlib"/>
			<Item Name="Thermometer DAQmx RTD Cont CFG.lvclass" Type="LVClass" URL="../../HAL/Devices/DAQmx/Thermo/Thermometer DAQmx RTD Cont CFG/Thermometer DAQmx RTD Cont CFG.lvclass"/>
			<Item Name="Validate Attributes JSON.vi" Type="VI" URL="../../HAL/Helper/Validate Attributes JSON.vi"/>
			<Item Name="Voegtlin_NI_SMART_Modbus_Drivers.lvlib" Type="Library" URL="../../HAL/Devices/Red-y/Voegtlin_NI_SMART_Modbus_Drivers/Voegtlin_NI_SMART_Modbus_Drivers.lvlib"/>
		</Item>
