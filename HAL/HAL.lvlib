...
<Library LVVersion="24008000">
	...
	<Item Name="Strategies" Type="Folder">
		<Item Name="Perform Action Strategies" Type="Folder">
			...
			<Item Name="Perform Action Remote on Const Channel with DBL Strategy.lvclass" Type="LVClass" URL="../Virtual Instruments/PA Remote on Const Channel with DBL Strategy/Perform Action Remote on Const Channel with DBL Strategy.lvclass"/>
			<Item Name="Perform Action Remote Strategy.lvclass" Type="LVClass" URL="../Virtual Instruments/Perform Action Remote Strategy.lvclass"/>
			<Item Name="Perform Action Strategy.lvclass" Type="LVClass" URL="../Virtual Instruments/Perform Action Strategy/Perform Action Strategy.lvclass"/>
		</Item>
		<Item Name="Scaling Strategies" Type="Folder">
			<Item Name="Linear Scaling Strategy.lvclass" Type="LVClass" URL="../Virtual Instruments/Linear Scaling Strategy/Linear Scaling Strategy.lvclass"/>
			<Item Name="No Scaling.lvclass" Type="LVClass" URL="../Virtual Instruments/No Scaling/No Scaling.lvclass"/>
			<Item Name="Scalar Scaling Strategy.lvclass" Type="LVClass" URL="../Virtual Instruments/Scalar Scaling Strategy/Scalar Scaling Strategy.lvclass"/>
			<Item Name="Scaling Strategy.lvclass" Type="LVClass" URL="../Virtual Instruments/Scaling Strategy/Scaling Strategy.lvclass"/>
		</Item>
		<Item Name="Virtual Instrument.lvclass" Type="LVClass" URL="../Virtual Instruments/Virtual Instrument/Virtual Instrument.lvclass"/>
	</Item>
	<Item Name="Instrument.lvclass" Type="LVClass" URL="../Instrument/Instrument.lvclass"/>
	<Item Name="MSS.lvclass" Type="LVClass" URL="../MSS/MSS.lvclass"/>
</Library>
