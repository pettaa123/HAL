...
<Library LVVersion="24008000">
	...
	<Item Name="AI Current DAQmx Cont CFG Simulated.lvclass" Type="LVClass" URL="../AI/AI Current DAQmx Cont CFG Simulated/AI Current DAQmx Cont CFG Simulated.lvclass"/>
	<Item Name="AI Voltage DAQmx Cont CFG Simulated.lvclass" Type="LVClass" URL="../AI/AI Voltage DAQmx Cont CFG Simulated/AI Voltage DAQmx Cont CFG Simulated.lvclass"/>
	<Item Name="AO DAQmx DC CFG Simulated.lvclass" Type="LVClass" URL="../AO/AO DAQmx DC Simulated CFG/AO DAQmx DC CFG Simulated.lvclass"/>
	<Item Name="CO DAQmx Fixed Freq PWM CFG Simulated.lvclass" Type="LVClass" URL="../DIO/DIO DAQmx Simulated CFGs/CO DAQmx PWM Fixed Freq CFG/CO DAQmx Fixed Freq PWM CFG Simulated.lvclass"/>
