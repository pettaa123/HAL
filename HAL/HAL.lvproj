...
<Project Type="Project" LVVersion="23008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Configurator" Type="Folder">
			<Item Name="Configuration UI Actor.lvlib" Type="Library" URL="../../Configurator/Configuration UI Actor.lvlib"/>
		</Item>
			...
			<Item Name="CAN Interfaces" Type="Folder">
				<Item Name="PCAN" Type="Folder">
					<Item Name="Tests" Type="Folder">
						<Item Name="Test PCAN.lvclass" Type="LVClass" URL="../Devices/CAN Interfaces/PCAN/Tests/Test PCAN.lvclass"/>
					</Item>
					<Item Name="PCAN.lvclass" Type="LVClass" URL="../Devices/CAN Interfaces/PCAN/PCAN.lvclass"/>
				</Item>
				<Item Name="XNET" Type="Folder">
					<Item Name="XNET Base CFG.lvclass" Type="LVClass" URL="../Devices/CAN Interfaces/XNET/XNET Base CFG/XNET Base CFG.lvclass"/>
				</Item>
			</Item>
			<Item Name="DAQmx" Type="Folder">
				<Item Name="AI" Type="Folder">
					<Item Name="AI Current DAQmx Cont CFG.lvclass" Type="LVClass" URL="../Devices/DAQmx/AI/AI Current DAQmx Cont CFG/AI Current DAQmx Cont CFG.lvclass"/>
					<Item Name="AI Voltage DAQmx Cont CFG.lvclass" Type="LVClass" URL="../Devices/DAQmx/AI/AI Voltage DAQmx Cont CFG/AI Voltage DAQmx Cont CFG.lvclass"/>
				</Item>
				<Item Name="AO" Type="Folder">
					<Item Name="AO DAQmx DC CFG.lvclass" Type="LVClass" URL="../Devices/DAQmx/AO/AO DAQmx DC CFG/AO DAQmx DC CFG.lvclass"/>
				</Item>
		...
		<Item Name="Helper" Type="Folder">
			<Item Name="Tests" Type="Folder">
				<Item Name="Test Strict Find Items as LV Type.lvclass" Type="LVClass" URL="../Helper/Strict Find Item as LV Type/Test Strict Find Items as LV Type/Test Strict Find Items as LV Type.lvclass"/>
			</Item>
		...
		<Item Name="Interfaces" Type="Folder">
			<Item Name="ICAN.lvclass" Type="LVClass" URL="../Protocols/ICAN/ICAN.lvclass"/>
		</Item>
